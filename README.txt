...
The following example reproduces the dense simulation result for the first-order derivatives of the mean and covariance functions using the proposed OCRL method.
...
setwd("Simulation/OCRL")
source("basic functions.R")
source("Cov-1st_C_dense_OCRL.R")
source("Cov1-st_dense_sparse_OCRL.R ")
